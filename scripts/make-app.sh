...
# The notices MIT, BSD, Apache-2.0 and the font licences ask a binary
# distribution to carry, generated by scripts/third-party-notices.py and
# kept current by CI. Required: a bundle without them ships other
# people's code without the one thing their licences ask for.
